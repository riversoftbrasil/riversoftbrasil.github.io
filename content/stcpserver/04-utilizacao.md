...
{{< icon "arrow-right-circle" >}}Para adicionar um servidor, clique no botão **Adicionar Servidor** (imagem abaixo).

![](img/console-02.png)

{{< icon "arrow-right-circle" >}}Na guia **Geral**, preencha os parâmetros:
...
{{< icon "arrow-right-circle" >}}Na guia **TCP/IP**, preencha os parâmetros:
...
{{< icon "arrow-right-circle" >}}Na guia **SSL3(Openssl)**, preencha os parâmetros:
...
{{< icon "arrow-right-circle" >}}Na guia **Monitor**, preencha os parâmetros:
...
{{< icon "arrow-right-circle" >}}Depois de definidos todos os parâmetros do novo servidor, clique no botão **OK** para que as informações do novo servidor sejam salvas. Após isso, o novo servidor deve aparecer na árvore de servidores, e caso ele esteja selecionado, suas informações devem ser exibidas na lista ao lado.
...
{{< icon "arrow-right-circle" >}}Para adicionar uma visão, clique no botão **Adicionar Visão**
...
{{< icon "arrow-right-circle" >}}Depois de definir os parâmetros da nova visão, clique no botão **OK** para que as informações sejam salvas. A nova visão deve aparecer na árvore de servidores, abaixo do nome do servidor.

![](img/console-08.png)

#### Como editar os dados de um servidor

{{< icon "arrow-right-circle" >}}Para editar os dados de um servidor, clique sobre o nome do servidor desejado com o botão direito do mouse e escolha a opção **Propriedades**.
...
{{< icon "arrow-right-circle" >}}Para visualizar os dados de um servidor, clique sobre o nome do servidor desejado com o botão direito do mouse e escolha a opção **Visualizar**.
...
{{< icon "arrow-right-circle" >}}Para editar os dados de uma visão, clique sobre o nome da visão desejada com o botão direito do mouse e escolha a opção **Editar**
...
{{< icon "arrow-right-circle" >}}Para visualizar os dados de uma visão, clique sobre o nome da visão desejada com o botão direito do mouse e escolha a opção **Visualizar**.
...
{{< icon "arrow-right-circle" >}}Para remover um servidor, selecione o servidor desejado na árvore e clique sobre o botão **Remover Servidor**.
...
{{< icon "arrow-right-circle" >}}Para remover uma visão, selecione a visão desejada na árvore e clique sobre o botão **Remover Visão**.
...
{{< icon "arrow-right-circle" >}}Para realizar a monitoração de usuários, clique com o botão direito do mouse sobre a visão desejada e escolha a opção **Monitorar → Usuário**.
...
{{< icon "arrow-right-circle" >}}Para realizar a monitoração de eventos, clique com o botão direito do mouse sobre a visão desejada e escolha a opção **Monitorar → Eventos**
...
{{< icon "arrow-right-circle" >}}Para fazer uso desta funcionalidade, clique sobre o botão **Filtro de Eventos**. Será exibida a tela onde o usuário deve definir o filtro e a quantidade de mensagens de eventos, em seguida, clique no botão **OK** para que a monitoração seja atualizada com as novas informações.
...
{{< icon "arrow-right-circle" >}}Para realizar a monitoração de usuários e eventos, clique com o botão direito do mouse sobre a visão desejada e escolher a opção **Monitorar → Todos**.
...
{{< icon "arrow-right-circle" >}}Para iniciar uma conexão com um usuário, clique sobre o nome da visão desejada com o botão direito do mouse e escolha a opção **Iniciar Conexão**, como mostra a imagem.

![](img/console-25.png)

{{< icon "arrow-right-circle" >}}Informe o usuário:
...
{{< icon "arrow-right-circle" >}}Nesta tela, selecione o usuário desejado e clique no botão **OK**, ou então, dê um clique duplo sobre o nome do usuário e automaticamente esse nome irá para o parâmetro **Usuário**.
