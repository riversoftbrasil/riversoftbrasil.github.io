---
title: "Eventos - Usuários"
description: "Consulta aos logs de transferência dos usuários"
weight: 2
toc: true
---
## Descrição

Este endpoint permite ao integrador consultar os logs de transferência dos Usuários (caixas postais).

## HTTP request

```text
GET /reports/v2/users
```
...
```text
GET /reports/v2/users?instance=STCPGEMINI&start=1766188800000&end=1766275199000&limit=1000
...
| `USUARIO` | `string` | Nome do Usuário (Caixa postal). |
...
```json
{
  "data": [
    {
      "DATAHORA": "2025-12-20T20:03:05-03:00",
      "INSTANCE": "STCPLAB01",
      "USUARIO": "01USER",
      "CODIGOMENSAGEM": "MSG0065",
      "MENSAGEM": "code=MSG0065 direction=OUT msg=\"fim de conexao de saída...\""
    }
  ],
  "next": "/reports/v2/users?end=1786579199000&index=45011&instance=STCPLAB01&limit=1&start=1785553200000"
}
```
...
```text
/reports/v2/users?end=1786579199000&index=45011&instance=STCPLAB01&limit=1&start=1785553200000
```
