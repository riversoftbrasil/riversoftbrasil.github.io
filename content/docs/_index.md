...
### Procedimentos
{{< cards >}}
  {{< card link="../referencias/conection/" title="Conectividade" icon="link" >}}
{{< /cards >}}

### Informações

{{< cards >}}
  {{< card link="../referencias/database/" title="Banco de dados" icon="database" >}}
  {{< card link="../referencias/requirements/" title="Requisitos de Software e Hardware" icon="numbered-list" >}}
