...
Os logs contendo as informações sobre a atualização são registrados no arquivo “stcpupdater_client.log", disponível na pasta “UPDATER”, do diretório de instalação da aplicação (Ex. C:\ STCPCLT-ITAU).
