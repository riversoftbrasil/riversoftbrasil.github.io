---
linkTitle: STCP OFTP Client | Sodexo
title: 
excludeSearch: true
layout: docs
toc: true
...
```bash
$ stcpclient -p O0055SODEXO -r 1 /usr/local/stcpclient/configs/stcpclient.config.json
```
...
```
/usr/local/stcpclient/data/STCPClt/O0055SODEXO/SAIDA
```
...
```
/usr/local/stcpclient/data/STCPClt/O0055SODEXO/ENTRADA
```
...
0 0 * * * /bin/bash -l -c "PATH=\"$PATH:/usr/local/bin\"; stcpclient -p O0055SODEXO -r 1 /usr/local/stcpclient/configs/stcpclient.config.json"
```
