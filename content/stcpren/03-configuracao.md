...
{{< icon "arrow-right-circle" >}}Acesse a pasta de instalação do STCPRen e execute o programa **STCPRenCfg.exe**.

{{< icon "arrow-right-circle" >}}Clique no botão **Adicionar** para selecionar o arquivo de configuração ou criar um novo.

![](img/stcpren-03.png)

{{< icon "arrow-right-circle" >}}Clique no botão indicado para localizar o arquivo.

![](img/stcpren-04.png)

{{< icon "arrow-right-circle" >}}Para criar um novo arquivo, digite um novo nome e clique no botão **Abrir**.

![](img/stcpren-05.png)

{{< icon "arrow-right-circle" >}}Clique no botão **OK** para adicionar ou criar o arquivo de configuração de regras.

![](img/stcpren-06.png)

{{< icon "arrow-right-circle" >}}Caso o arquivo de configuração não exista, uma janela de aviso será apresentada, clique no botão **Sim** para confirmar.

![](img/stcpren-07.png)

## Alterar os parâmetros de configuração do arquivo de regras

{{< icon "arrow-right-circle" >}}Selecione o arquivo de configuração desejado e clique no botão **Propriedades**.

![](img/stcpren-08.png)

{{< icon "arrow-right-circle" >}}Na guia **Geral**, configure os parâmetros desejados.
...
{{< icon "arrow-right-circle" >}}Na guia **Acesso**, é possível configurar os parâmetros para utilização de um compartilhamento de rede.
...
{{< icon "arrow-right-circle" >}}Na guia **Log**, é possível configurar os parâmetros para gravação dos registros de eventos de execução do STCPRen.
...
{{< icon "arrow-right-circle" >}}Na guia **Variáveis**, você pode definir regras de substituição dos valores informados nas variáveis (–var0 à –var9) utilizados na linha de comando do STCPRen.

![](img/stcpren-12.png)

{{< icon "arrow-right-circle" >}}Clique no botão **Adicionar** para configurar uma nova **regra de substituição dos valores de uma variável**.

![](img/stcpren-13.png)

{{< icon "arrow-right-circle" >}}Configure os parâmetros da regra de substituição e clique no botão **OK** para salvar.
...
{{< icon "arrow-right-circle" >}}Na guia **Listas**, você pode substituir as linhas do arquivo pelos valores das variáveis (-var0 à -var9) ou através de uma expressão regular criando regras de substituição.
...
{{< icon "arrow-right-circle" >}}Clique no botão **Adicionar** para configurar uma nova **regra de substituição através de uma variável**.
...
{{< icon "arrow-right-circle" >}}Clique no botão **Adicionar** para configurar uma nova **regra de substituição através de uma expressão regular**.
...
{{< icon "arrow-right-circle" >}}Na guia **Regras de Validação**, clique no botão **Adicionar** para criar uma nova regra ou selecione uma regra e clique no botão **Propriedades** para modificá-la.

![](img/stcpren-20.png)

{{< icon "arrow-right-circle" >}}Clique no botão **Adicionar** para criar uma nova regra.

![](img/stcpren-21.png)

{{< icon "arrow-right-circle" >}}Configure a identificação da regra e clique no botão **OK** para salvar.
...
{{< icon "arrow-right-circle" >}}Selecione uma regra e clique no botão **Ordenar regras**.

![](img/stcpren-23.png)

{{< icon "arrow-right-circle" >}}Nesta tela, selecione o intervalo de ordenação das regras:

![](img/stcpren-24.png)

{{< icon "arrow-right-circle" >}}Selecione uma regra e clique no botão **Propriedades** para modificar os seus parâmetros.
...
{{< icon "arrow-right-circle" >}}Na guia **Geral**, configure os parâmetros de identificação da regra, validação do arquivo e outros:
...
{{< icon "arrow-right-circle" >}}Na guia **Renomeio de Arquivo I**, configure os parâmetros que serão utilizados na definição do **Novo Nome do Arquivo**.
...
{{< icon "arrow-right-circle" >}}Na guia **Renomeio de Arquivo I**, clique em **Adicionar** e configure as regras de renomeio do **Novo Nome do Arquivo** com as opções de **Substituição através do nome original**.

![](img/stcpren-33.png)

{{< icon "arrow-right-circle" >}}Configure as opções de substituição através do nome original do arquivo e do diretório, variáveis, número de sequência, timestamp e clique no botão **OK** para salvar.
...
{{< icon "arrow-right-circle" >}}Na guia **Renomeio de Arquivo II**, configure as regras de renomeio do **Novo Nome do Arquivo** através do conteúdo do arquivo original ou de uma expressão regular:
...
{{< icon "arrow-right-circle" >}}Clique em **Adicionar** para configurar as regras de **Substituição através do conteúdo do arquivo original** que serão aplicadas no **Novo Nome do Arquivo**:

![](img/stcpren-36.png)

{{< icon "arrow-right-circle" >}}Configure os parâmetros de substituição e clique no botão **OK** para salvar.
...
{{< icon "arrow-right-circle" >}}Clique em **Adicionar** para configurar as regras de **Substituição através de uma expressão regular** que serão aplicadas no **Novo Nome do Arquivo**:
...
{{< icon "arrow-right-circle" >}}Na guia **Cópia**, configure os parâmetros que serão utilizados na definição do **Novo Nome do Diretório** para onde será copiado o arquivo original.
...
{{< icon "arrow-right-circle" >}}Clique em **Adicionar** para configurar as regras de **Substituição através do nome original** que serão aplicadas no **Novo Nome do Diretório**.
...
{{< icon "arrow-right-circle" >}}Clique em **Adicionar** para configurar as regras de **Substituição através de expressão regular** que serão aplicadas no **Novo Nome do Diretório**.
...
{{< icon "arrow-right-circle" >}}Na guia **Backup**, configure os parâmetros que serão utilizados na definição do **Novo Nome do Diretório**, para onde será copiado o arquivo original:
...
{{< icon "arrow-right-circle" >}}Clique em **Adicionar** para configurar as regras de **Substituição através do nome original** que serão aplicadas no **Novo Nome do Diretório** de backup.
...
{{< icon "arrow-right-circle" >}}Clique em **Adicionar** para configurar as regras de **Substituição através de expressão regular** que serão aplicadas no **Novo Nome do Diretório** de
backup.
...
{{< icon "arrow-right-circle" >}}Na guia **Avançadas**, configure os parâmetros:
